      ...
      <div className="sticky top-0 z-[1000] bg-white border-b-[1px] border-gray-200 pb-[20px]">
          ...
          <div className="container">
            <div className="grid grid-cols-[auto_1fr_auto] gap-5 md:gap-[150px] items-center py-4 lg:py-0 mb-[30px]">
              <div className="flex items-center gap-3">
                <RxHamburgerMenu className="text-xl mb-[2px]" />
                <p className="mb-0 text-[13px]">Tuesday, December 26, 2023</p>
              </div>
        ...
        <header className="bg-white sticky top-0 z-[1000]">
          <div className="container-extended">
            {/* <div className="grid grid-cols-[auto_1fr_auto] gap-5 md:gap-[50px] items-center py-4 lg:py-0"> */}
            <div className="flex gap-5 md:gap-[50px] justify-center items-center py-4 lg:py-0">
                        ...
                        return (
                          ...
                          >
                            {item?.link ? (
                              ...
                              >
                                <div>
                                  <span className="2lg:text-[15px] xl:text-base inline-block px-4 py-4">
                                    {item?.title}
                                  </span>
