...
export default function CartMedium() {
  return (
    <Link href={"/"} className="group hover:text-inherit">
      <div className=" flex flex-col gap-[12px] h-[190px]">
        <Image
          height={75}
          width={615}
      ...
      <div className=" grid gap-3">
        ...
        <p className=" mb-0 line-clamp-4">
          নির্বাচন নিয়ে নাশকতাকারীদের তথ্য দিলে ২০ হাজার টাকা থেকে ১ লাখ টাকা
          পুরস্কারের ঘোষণা দিয়েছেন পুলিশের মহাপরিদর্শক (আইজিপি) চৌধুরী আবদুল্লাহ
          আল-মামুন।
        </p>
